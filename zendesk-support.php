...
class Zendesk_Support {
  ...
  public function _admin_init() {
    ...
    if ( $this->settings['account'] ) {
      ...
      add_settings_field( 'strategy', __( 'Remote Auth Strategy', 'zendesk' ), array( &$this, '_settings_remote_auth_strategy' ), 'zendesk-settings-remote-auth', 'general' );
  ...
  public function _settings_remote_auth_strategy() {
    ...
    $current_strategy    = $this->remote_auth_settings['strategy'];
    $remote_auth_enabled = $this->remote_auth_settings['enabled'];
